...
const katexImagesData = {
  'overrightarrow': _KatexImagesData(
    ['rightarrow'],
    0.888,
    522,
    Alignment.topRight,
  ),
  'overleftarrow': _KatexImagesData(
    ['leftarrow'],
    0.888,
    522,
    Alignment.topLeft,
  ),
  'underrightarrow': _KatexImagesData(
    ['rightarrow'],
    0.888,
    522,
    Alignment.topRight,
  ),
  'underleftarrow': _KatexImagesData(
    ['leftarrow'],
    0.888,
    522,
    Alignment.topLeft,
  ),
  'xrightarrow': _KatexImagesData(
    ['rightarrow'],
    1.469,
    522,
    Alignment.topRight,
  ...
  'xLeftarrow': _KatexImagesData(
    ['doubleleftarrow'],
    1.526,
    560,
    Alignment.topLeft,
  ),
  'overleftharpoon': _KatexImagesData(
    ['leftharpoon'],
    0.888,
    522,
    Alignment.topLeft,
  ),
  'xleftharpoonup': _KatexImagesData(
    ['leftharpoon'],
    0.888,
    522,
    Alignment.topLeft,
  ),
  'xleftharpoondown': _KatexImagesData(
    ['leftharpoondown'],
    0.888,
    522,
    Alignment.topLeft,
  ),
  'overrightharpoon': _KatexImagesData(
    ['rightharpoon'],
    0.888,
    522,
    Alignment.topRight,
  ),
  'xrightharpoonup': _KatexImagesData(
    ['rightharpoon'],
    0.888,
    522,
    Alignment.topRight,
  ),
  'xrightharpoondown': _KatexImagesData(
    ['rightharpoondown'],
    0.888,
    522,
    Alignment.topRight,
  ...
  'xtwoheadleftarrow': _KatexImagesData(
    ['twoheadleftarrow'],
    0.888,
    334,
    Alignment.topLeft,
  ),
  'xtwoheadrightarrow': _KatexImagesData(
    ['twoheadrightarrow'],
    0.888,
    334,
    Alignment.topRight,
  ...
  'overleftrightarrow': _KatexImagesData(
    ['leftarrow', 'rightarrow'],
    0.888,
    522,
  ),
  'overbrace': _KatexImagesData(
  ...
  'underleftrightarrow': _KatexImagesData(
    ['leftarrow', 'rightarrow'],
    0.888,
    522,
  ),
  'xleftrightarrow': _KatexImagesData(['leftarrow', 'rightarrow'], 1.75, 522),
  'xLeftrightarrow': _KatexImagesData(
    ['doubleleftarrow', 'doublerightarrow'],
    1.75,
    560,
  ),
  'xrightleftharpoons': _KatexImagesData(
    ['leftharpoondownplus', 'rightharpoonplus'],
    1.75,
    716,
  ),
  'xleftrightharpoons': _KatexImagesData(
  ...
  'overlinesegment': _KatexImagesData(
    ['leftlinesegment', 'rightlinesegment'],
    0.888,
    522,
  ),
  'underlinesegment': _KatexImagesData(
    ['leftlinesegment', 'rightlinesegment'],
    0.888,
    522,
  ),
  'overgroup': _KatexImagesData(['leftgroup', 'rightgroup'], 0.888, 342),
  'undergroup': _KatexImagesData(
  ...
  'xrightleftarrows': _KatexImagesData(
...
class StrechySvgSpanWidget extends StatelessWidget {
  const StrechySvgSpanWidget({
    required this.name,
    required this.width,
  ...
  Widget build(BuildContext context) {
    ...
    if (const {'widehat', 'widecheck', 'widetilde', 'utilde'}.contains(name)) {
      ...
      return SvgWidgetFromPath(
        path: svgPaths[pathName]!,
        viewPort: Size(width, height),
        viewBox: Rect.fromLTWH(0, 0, viewBoxWidth, viewBoxHeight),
        color: options.color,
      );
    } else {
      ...
      final actualWidth = math.max(
        width,
        data.minWidth.cssEm.toLpUnder(options),
      );
      ...
      return Row(
        ...
        children: List.generate(
          ...
          (index) => SvgWidgetFromPath(
            path: svgPaths[data.paths[index]]!,
            viewPort: Size(widths[index], height),
            viewBox: Rect.fromLTWH(0, 0, viewBoxWidth, data.viewBoxHeight),
            color: options.color,
            align: aligns[index],
            fit: BoxFit
